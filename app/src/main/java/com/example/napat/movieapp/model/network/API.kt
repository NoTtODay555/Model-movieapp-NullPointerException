...
interface API {
    ...
    fun getSearchMovie(@Query("page") page: Int, @Query( "query") query : String) : Observable<PopularMovie>

    @GET("movie/{id}/credits?api_key=7bc5dd5396cab633f6b86f3e8fee0384")
    fun getActor(@Path("id") id : Int) : Observable<ActorDetail>

    @GET("movie/{id}/credits?api_key=7bc5dd5396cab633f6b86f3e8fee0384")
    fun getActor_test(@Path("id") id : Int) : Observable<ActorDetail>

    @GET ("movie/{id}?api_key=7bc5dd5396cab633f6b86f3e8fee0384&language=en-US")
    fun getMovieDetailxx(@Path("id") id : Int) : Observable<MovieDetail>
