...
import com.example.napat.movieapp.main.presenter.PresanterMain
import com.example.napat.movieapp.model.PopularMovie
import com.example.napat.movieapp.model.Result
import com.example.napat.movieapp.main.presenter.PresenterRecycleView
...
class Fragments (context: Context) : Fragment()
        , ConstuterViewMain.getApiPage,
        ConstuterViewMain.OnLoadMoreListener {
    ...
    private val presenterPopular  = PresenterRecycleView(this)
